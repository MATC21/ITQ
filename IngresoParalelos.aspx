<%@ Page Language="VB" AutoEventWireup="false" CodeFile="IngresoParalelos.aspx.vb" Inherits="IngresoParalelos" %>
                                        ...
                                        <table class="style8">
                                            <tr>
                                                <td class="style53" style="text-align: left">
                                                    <asp:Label ID="Label28" runat="server" BorderWidth="0px" style="font-size: small; font-family: Verdana; font-weight: 700;" Text="Paralelo" Width="50px"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="style70" style="text-align: left">
                                                    <asp:TextBox ID="TxtParalelo" runat="server" Width="50px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
                ...
                <td class="style67">
                    <table class="style54">
                        <tr>
                            ...
                            <td class="style55">
                                <asp:Button ID="Button1" runat="server" Text="Grabar paralelo" 
                                    Width="261px" />
                                    ...
                                    <asp:TemplateField HeaderText="Código" Visible="False">
                                        <ItemTemplate>
                                            <asp:Label ID="lblNum" runat="server" 
                                                Text='<%# Bind("num") %>' Width="50px"></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Detalle del paralelo">
                                        <ItemTemplate>

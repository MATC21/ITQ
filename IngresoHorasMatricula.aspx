<%@ Page Language="VB" AutoEventWireup="false" CodeFile="IngresoHorasMatricula.aspx.vb" Inherits="IngresoHorasMatricula" %>
                                        ...
                                        <table class="style8">
                                            <tr>
                                                <td class="style53" style="text-align: left">
                                                    <asp:Label ID="Label30" runat="server" BorderWidth="0px" style="font-size: small; font-family: Verdana; font-weight: 700;" Text="Modalidad:" Width="50px"></asp:Label>
                                                </td>
                                                <td class="style53" style="text-align: left">
                                                    <asp:DropDownList ID="Cbomodalidad" runat="server" AutoPostBack="True" Width="160px">
                                                    </asp:DropDownList>
                                                </td>
                                                <td class="style53" style="text-align: left">Código:</td>
                                                <td class="style53" style="text-align: left">
                                                    <asp:Label ID="lblcodmodalidad" runat="server"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="style53" style="text-align: left">
                                                    <asp:Label ID="Label29" runat="server" BorderWidth="0px" style="font-size: small; font-family: Verdana; font-weight: 700;" Text="Día:" Width="50px"></asp:Label>
                                                </td>
                                                <td class="style53" style="text-align: left">
                                                    <asp:DropDownList ID="Cbodias" runat="server" AutoPostBack="True" Width="160px">
                                                    </asp:DropDownList>
                                                </td>
                                                <td class="style53" style="text-align: left">Código:</td>
                                                <td class="style53" style="text-align: left">
                                                    <asp:Label ID="lblcoddia" runat="server"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="style70" style="text-align: left">&nbsp;</td>
                                                <td class="style70" style="text-align: left">&nbsp;</td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
                        ...
                        <ContentTemplate>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Código">
                                        <ItemTemplate>
                                            <asp:Label ID="lblNum" runat="server" 
                                                Text='<%#Eval("numh") %>' Width="50px"></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Detalle">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDetalle_Periodo" runat="server" 
                                                Text='<%# Bind("DetalleH") %>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtDetalleSave" runat="server" 
                                                Text='<%# Bind("DetalleH") %>' Width="400px" MaxLength="200"></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Cod. Modalidad">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtcodmoda" runat="server" Text='<%# eval("Cod_modalidad") %>' Width="50px"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblcodmodalidad" runat="server" Text='<%# Eval("Cod_modalidad") %>' Width="50px"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Cod. Día">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtcoddia" runat="server" Text='<%# eval("Cod_dia") %>' Width="50px"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="Label31" runat="server" Text='<%# eval("Cod_dia") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
